...
public class Movie_InfoVO {
	...
	public String getCatecory_id() {
		return catecory_id;
	}
	public void setCatecory_id(String catecory_id) {
		this.catecory_id = catecory_id;
	}
	...
	public String toString() {
		return "Movie_InfoVO [movie_id=" + movie_id + ", catecory_id=" + catecory_id + ", user_id=" + user_id
				+ ", movie_title=" + movie_title + ", movie_content=" + movie_content + ", movie_img=" + movie_img
				+ ", movie_date=" + movie_date + ", movie_views=" + movie_views + "]";
	}
